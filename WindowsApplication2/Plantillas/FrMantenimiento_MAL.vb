...
Public Class FrMantenimiento
            ...
            If LbId.Text <> "" Then
                ...
                If Not EntidadFrm Is Nothing Then
                    If EntidadFrm.LeerId(LbId.Text) = True Then
                        'If CumpleFiltro(True) = True Then
                        NuevoRegistro = False
                        Entidad_a_Datos()
                        BloquearCampos(True)
                        BloquearClaves(True)
    ...
    Public Overridable Sub Modificar()
        ...
        If CumpleFiltro(True) = False Then
            Exit Sub
        End If
    ...
    Protected Overridable Sub Datos_a_Entidad()
        ...
        Next
    End Sub
    Protected Overridable Sub DatosLin_a_Entidad(ByVal gr As ClGrid, ByVal EntidadLin As Entidad)
    ...
    Public Sub Cargalineas(ByVal gr As ClGrid)
        If CumpleFiltro(False) = True Then
            Dim dt As New DataTable
            gr.Cargando = True
    ...
    Protected Function CumpleFiltro(Msg As Boolean) As Boolean
        If Not EntidadFrm Is Nothing Then
