...
Public Class miInforme
    ...
    Public Sub Dispose()
        ...
        If Not IsNothing(_Informe) Then
            For Each Link As DevExpress.XtraPrinting.Link In _Informe.Links
...
Public Class miFactura
    ...
    Private Class CTitulo
        ...
        Public Sub New(texto As String, x As Single, y As Single, lg_x As Integer, lg_y As Integer, estilo As milinea.stilos, alineacion As String, Optional fuente As Font = Nothing)
    ...
    Private Class CTipoLinea

        Public Grosor As Decimal = 0
        Public color As Color = color.Black

        Public Sub New(Grosor As Decimal, color As Color)
    ...
    Private Class CLineaH
        ...
        Public Sub New(x As Single, y As Single, lg As Integer, linea As CTipoLinea)
    ...
    Private Class CCuadro
        ...
        Public Sub New(x As Single, y As Single, lg_x As Integer, lg_y As Integer, linea As CTipoLinea)
    ...
    Private Class CLogo
        ...
        Public Sub New(x As Single, y As Single, lg_x As Integer, lg_y As Integer, archivo As String)
    ...
    Private _lineasCab As New List(Of Object)
    Private _lineasPie As New List(Of Object)
    ...
    Public Sub Titulo(texto As String, x As Single, y As Single, lg_x As Integer, lg_y As Integer, estilo As milinea.stilos, Optional alineacion As String = "<", Optional fuente As Font = Nothing)
    ...
    Public Sub Titulo_Pie(texto As String, x As Single, y As Single, lg_x As Integer, lg_y As Integer, estilo As milinea.stilos, alineacion As String, Optional fuente As Font = Nothing)
    ...
    Public Sub LineaH(x As Single, y As Single, lg As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub LineaH_Pie(x As Single, y As Single, lg As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub LineaV(x As Single, y As Single, lg As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub LineaV_Pie(x As Integer, y As Integer, lg As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub Cuadro(x As Single, y As Single, lg_x As Integer, lg_y As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub Cuadro_Pie(x As Single, y As Single, lg_x As Integer, lg_y As Integer, grosor As Decimal, color As Color)
    ...
    Public Sub Logo(x As Single, y As Single, lg_x As Integer, lg_y As Integer, archivo As String)
    ...
    Public Sub Logo_Pie(x As Single, y As Single, lg_x As Integer, lg_y As Integer, archivo As String)
    ...
    Public Sub SaltoPagina(y As Single)
    ...
    Private Sub linkCabecera_CreateDetailArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
        ...
        For Each obj As Object In _lineasCab
    ...
    Private Sub linkCabecera_CreateInnerPageFooter(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
        ...
        For Each obj As Object In _lineasPie
    ...
    Private Sub DibujaTitulo(titulo As CTitulo, ByVal e As CreateAreaEventArgs)
    ...
    Private Sub DibujaLineaH(linea As CLineaH, ByVal e As CreateAreaEventArgs)
    ...
    Private Sub DibujaLineaV(linea As CLineaV, ByVal e As CreateAreaEventArgs)
    ...
    Private Sub DibujaCuadro(cuadro As CCuadro, ByVal e As CreateAreaEventArgs)
    ...
    Private Sub DibujaLogo(logo As CLogo, ByVal e As CreateAreaEventArgs)
    ...
    Private Sub DibujaSaltoPagina(salto As CSaltoPagina, ByVal e As CreateAreaEventArgs)
