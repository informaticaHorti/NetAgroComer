Public Class E_DAT_ENTRADAS
    ...
    Public Sub New(ByVal idUsuario As Integer, ByVal conexion As Cdatos.Conexion)
        ...
        sql = sql & " CAST(CASE LEN(DAT_FECHALOG) WHEN 8 THEN CONCAT(CONCAT(SUBSTRING(DAT_FECHALOG, 7, 2), '/', SUBSTRING(DAT_FECHALOG, 5, 2)), '/', SUBSTRING(DAT_FECHALOG, 1, 4)) ELSE DAT_FECHALOG END as DATE) as Fecha" & vbCrLf
