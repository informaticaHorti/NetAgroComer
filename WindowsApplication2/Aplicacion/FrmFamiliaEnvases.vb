Public Class FrmFamiliaEnvases
    ...
    Private Sub ParametrosFrm()
        EntidadFrm = FamEnvases


        Dim lc As New List(Of Object)
        ListaControles = lc

        ParamTx(TxDato1, FamEnvases.FEV_IdFamilia, Lb1, True)
        CampoClave = 0 ' ultimo campo de la clave
        ParamTx(TxDato2, FamEnvases.FEV_Nombre, Lb2)




        AsociarControles(TxDato1, BtBuscaFamEnvase, FamEnvases.btBusca, EntidadFrm)
    ...
    Private Sub CargaGridFRm()
        ...
        Dim sql As String
        sql = "Select FEV_idfamilia as id,FEV_nombre as nombre from " + EntidadFrm.NombreTabla + " order by " + EntidadFrm.ClavePrimaria.NombreCampo
