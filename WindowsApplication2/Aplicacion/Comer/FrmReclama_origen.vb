Public Class FrmReclama_origen
    ...
    Private Sub ParametrosFrm()
        EntidadFrm = Reclama_origen


        Dim lc As New List(Of Object)
        ListaControles = lc

        ParamTx(TxDato1, Reclama_origen.RCO_Idorigen, Lb1, True)
        CampoClave = 0 ' ultimo campo de la clave
        ParamTx(TxDato2, Reclama_origen.RCO_Nombre, Lb2)

        AsociarControles(TxDato1, BtBuscaMarca, Reclama_origen.btBusca, EntidadFrm)
    ...
    Private Sub CargaGridFRm()
        ...
        Dim sql As String
        sql = "Select RCO_idorigen as id,RCO_nombre as nombre from " + EntidadFrm.NombreTabla + " order by " + EntidadFrm.ClavePrimaria.NombreCampo
