...
Public Class FrmListadoHistAlbEntradaDetallado
    Inherits FrConsulta
    ...
    Public Overrides Sub Informe()
        ...
        If Not IsNothing(dt) Then
            If dt.Rows.Count > 0 Then
                ...
                ImprimirListadoHistAlbaranesEntradaDetallado(dt, TxDato1.Text, TxDato2.Text, TxDato3.Text, TxDato4.Text, TxDato5.Text, TxDato6.Text,
