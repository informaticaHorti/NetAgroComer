Public Class FrmMedidasPalets
    ...
    Private Sub ParametrosFrm()
        EntidadFrm = MedidasPalets


        Dim lc As New List(Of Object)
        ListaControles = lc

        ParamTx(TxDato1, MedidasPalets.PLM_Id, Lb1, True)
        CampoClave = 0 ' ultimo campo de la clave
        ParamTx(TxDato2, MedidasPalets.PLM_Medidas, Lb2)




        AsociarControles(TxDato1, BtBuscaFamEnvase, MedidasPalets.btBusca, EntidadFrm)
    ...
    Private Sub CargaGridFRm()
        ...
        Dim sql As String
        sql = "Select PLM_id as id,PLM_medidas as Medidas from " + EntidadFrm.NombreTabla + " order by " + EntidadFrm.ClavePrimaria.NombreCampo
