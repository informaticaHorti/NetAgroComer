Public Class FrmReclama_solucion
    ...
    Private Sub ParametrosFrm()
        EntidadFrm = Reclama_resolucion


        Dim lc As New List(Of Object)
        ListaControles = lc

        ParamTx(TxDato1, Reclama_resolucion.RCS_Idsolucion, Lb1, True)
        CampoClave = 0 ' ultimo campo de la clave
        ParamTx(TxDato2, Reclama_resolucion.RCS_Nombre, Lb2)

        AsociarControles(TxDato1, BtBuscaMarca, Reclama_resolucion.btBusca, EntidadFrm)
    ...
    Private Sub CargaGridFRm()
        ...
        Dim sql As String
        sql = "Select RCS_idsolucion as id,RCS_nombre as nombre from " + EntidadFrm.NombreTabla + " order by " + EntidadFrm.ClavePrimaria.NombreCampo
