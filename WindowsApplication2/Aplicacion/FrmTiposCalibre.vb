Public Class FrmTiposCalibre
    Inherits FrMantenimiento
    Dim TiposdeCalibre As New E_TiposdeCalibre(Idusuario, cn)


    Private Sub ParametrosFrm()
        EntidadFrm = TiposdeCalibre


        Dim lc As New List(Of Object)
        ListaControles = lc

        ParamTx(TxDato1, TiposdeCalibre.TCB_Id, Lb1, True)
        CampoClave = 0 ' ultimo campo de la clave
        ParamTx(TxDato2, TiposdeCalibre.TCB_Nombre, Lb2)




        AsociarControles(TxDato1, BtBuscaTgasto, TiposdeCalibre.btBusca, EntidadFrm)
